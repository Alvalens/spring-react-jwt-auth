  ...
  return (
    <div className="min-h-screen flex bg-[#0a0a0b]">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="absolute top-[30%] left-[20%] w-56 h-56 border border-amber-500/10 rounded-full" />
        <div className="absolute bottom-[30%] right-[20%] w-36 h-36 border border-amber-400/10 rotate-45" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6 max-w-md">
            ...
            <p className="text-white/40 text-base leading-relaxed">
              No worries — we'll send you a link to reset your password and get
